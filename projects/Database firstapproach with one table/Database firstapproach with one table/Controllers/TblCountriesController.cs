...
using Database_firstapproach_with_one_table.Models;

namespace Database_firstapproach_with_one_table.Controllers
{
    public class TblCountriesController : Controller
    {
        private readonly CountryDbContext _context;

        public TblCountriesController(CountryDbContext context)
        {
            _context = context;
        }
